...
public class CaptureHelper extends ScreenRecorder {
    ...
    public static void startRecord(String methodName) {
        ...
        File file = new File(SystemHelper.getCurrentDir() + ConfigData.RECORDVIDEOS);
    ...
    public static void captureScreenshot(String screenshotName) {
        try {
            ...
            File theDir = new File(SystemHelper.getCurrentDir() + ConfigData.SCREENSHORTS);
            if (!theDir.exists()) {
                theDir.mkdirs();
            }
            // Chổ này đặt tên thì truyền biến "screenName" gán cho tên File chụp màn hình
            FileHandler.copy(source, new File(SystemHelper.getCurrentDir() + ConfigData.SCREENSHORTS + File.separator + screenshotName + "_" + dateFormat.format(new Date()) + ".png"));
